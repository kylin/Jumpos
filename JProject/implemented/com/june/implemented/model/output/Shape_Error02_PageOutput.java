...
public class Shape_Error02_PageOutput extends com.june.generated.model.output.Shape_Error02_PageOutput {
	public Shape_Error02_PageOutput() {
		super();
	}
	
	public Shape_Error02_PageOutput(Process currentProcess) {
		super();
