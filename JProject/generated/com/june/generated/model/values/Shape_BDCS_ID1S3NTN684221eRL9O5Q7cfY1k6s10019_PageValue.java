...
/**
 * 	FileName   : Shape_BDCS_ID1S3NTN684221eRL9O5Q7cfY1k6s10019_PageValue
 * 	Package    : com.june.generated.model.values
 *	Create Time: 2016-5-25 7:25:28
...
public class Shape_BDCS_ID1S3NTN684221eRL9O5Q7cfY1k6s10019_PageValue extends AbstractPageValues{
	...
	public Shape_BDCS_ID1S3NTN684221eRL9O5Q7cfY1k6s10019_PageValue() {
		super();
        this.LoadInitData();
	}
	...
	BDCSWorkData workData = (BDCSWorkData) process.getActiveWorkObject().getWorkDataInstance();	
		...
		javax.faces.model.SelectItem shifoutongguoshenhe51727items0 = new javax.faces.model.SelectItem("是", "是");
		this.shifoutongguoshenhe51727List.add(shifoutongguoshenhe51727items0);
		javax.faces.model.SelectItem shifoutongguoshenhe51727items1 = new javax.faces.model.SelectItem("否", "否");
		this.shifoutongguoshenhe51727List.add(shifoutongguoshenhe51727items1);	
	

	}

	public void getDataFromOutput(Shape_BDCS_ID1S3NTN684221eRL9O5Q7cfY1k6s10019_PageOutput pageOutput) {
		...
		setShifoutongguoshenhe51727(pageOutput.getShifoutongguoshenhe51727());
		setSqbbtgyy78335(pageOutput.getSqbbtgyy78335());
		
	}
	
	public void setDataToInput(Shape_BDCS_ID1S3NTN684221eRL9O5Q7cfY1k6s10019_UserInput userInput) {
		userInput.setShifoutongguoshenhe51727(getShifoutongguoshenhe51727());
		userInput.setSqbbtgyy78335(getSqbbtgyy78335());
